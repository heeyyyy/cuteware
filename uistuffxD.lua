...
local library = {
    ...
    settings = {
        guiname = "Hexagon",
		title = "CUTEWARE CRACK DLL 1995 WORKING NO VAC BAN SAFE DOWNLOAD NO TORRENT",
		logo = "", -- "",
        footer = " wassup",
        modal = true,
    ...
    theme = {
        buttons = Color3.fromRGB(128, 0, 128), -- toggle, sliders colors
        text = Color3.fromRGB(128, 0, 128),
        textboxtext = Color3.fromRGB(128, 0, 128),
        main = Color3.fromRGB(128, 0, 128),
        outline = Color3.fromRGB(128, 0, 128),
        tabholder = Color3.fromRGB(128, 0, 128),
        tabbutton = Color3.fromRGB(128, 0, 128),
        tabselected = Color3.fromRGB(128, 0, 128)
    }
}
